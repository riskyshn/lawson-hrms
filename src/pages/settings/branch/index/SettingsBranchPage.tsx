...
const SettingsBranchPage: React.FC = () => {
  ...
  const [pageData, setPageData] = useState<PaginationResponse<IBranch>>()
  ...
  return (
    <>
      ...
      <Modal show={showModal} onClose={closeModal} branch={selectedBranch} onSubmitSuccess={handleSubmitSuccess} />
    </>
  )
}
