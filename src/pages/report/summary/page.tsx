import type { Dataset, INumberOfHired, INumberOfHiredDataTable, IPaginationResponse, IRecruitmentFunnel } from '@jshrms/shared/types'
...
import { BaseInputDateRange, Card, CardBody, Select, Spinner } from '@jshrms/ui'
