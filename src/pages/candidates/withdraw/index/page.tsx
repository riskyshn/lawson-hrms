import type { ICandidate, IPaginationResponse } from '@jshrms/shared/types'
...
import { candidateService, masterService, vacancyService } from '@jshrms/shared/services'
...
const CandidateWithdrawPage: React.FC = () => {
  ...
  return (
    <>
      <PageHeader breadcrumb={[{ text: 'Candidate' }, { text: 'Withdraw' }]} title="Candidate Withdraw" />
