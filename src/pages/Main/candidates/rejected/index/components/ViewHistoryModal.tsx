    ...
    jobApplicationProcess: [
      {
        ...
        details: [{
          ...
          processRemarks: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugit laborum quo labore culpa nam, pariatur numquam unde, voluptatibus expedita cumque assumenda voluptate. Animi rerum asperiores a officia corrupti ipsa debitis.',
                ...
                <li key={idx} className="relative mb-5 pl-6 last:mb-0">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mb-2">{process.date}</p>
                      <Button
                        type="button"
                        size="small"
                        color="default"
                  ...
                  {showDetails[idx] && (
                    <Card className="mt-4 py-4 px-2">
                      <CardBody>
                        <div className="mb-3">
                          <h3 className="font-semibold text-sm">Attendee</h3>
                        ...
                        <div className="mb-3">
                          <h3 className="font-semibold text-sm">Action Scheduled</h3>
                          <span className="flex items-center gap-1 text-xs">
                        ...
                        <div className="mb-3">
                          <h3 className="font-semibold text-sm">Process Date</h3>
                          <span className="flex items-center gap-1 text-xs">
                            <CalendarIcon size={16} />
                        ...
                        <div className="mb-3">
                          <h3 className="font-semibold text-sm">Process Remarks</h3>
                          <span className="flex items-center gap-1 text-xs">
                            {process.details[0].processRemarks}
                          </span>
                        </div>
