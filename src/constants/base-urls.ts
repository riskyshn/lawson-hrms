...
export const API_CANDIDATE_EXPLORE_BASE_URL = import.meta.env.VITE_API_CANDIDATE_EXPLORE_BASE_URL || 'https://candidate.api-jobseeker.site'
export const API_NOTIFICATION_BASE_URL = import.meta.env.VITE_API_NOTIFICATION_BASE_URL || 'https://basic-notification.api-jobseeker.site'
